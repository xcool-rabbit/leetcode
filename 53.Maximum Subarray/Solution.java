...
/*
  ...
  题目当中进阶要求用nlogn的分治法来实现，我8是很懂，我看了一下，弄懂了，
  就是最大连续子数组，要么来自左边，要么来自右边，要么是左右都有，
  每次递归就返回，左边，右边，和两边都有，这三种情况的最大值
  左边和右边的最大值都是下一层递归返回的，那么两边都有的怎么算呢
  从中间往两边遍历，求和，记录最大的和，就是两边都有的情况的最大值
  执行用时：1 ms 已经战胜 99.97 % 的 java 提交记录
*/
class Solution {
    public int maxSubArray(int[] nums) {
